function _G.set_terminal_keymaps()
  ...
  vim.keymap.set('t', '<C-a>j', [[<Cmd>wincmd j<CR>]], opts)
  vim.keymap.set('t', '<C-a>k', [[<Cmd>wincmd k<CR>]], opts)
  vim.keymap.set('t', '<C-a>l', [[<Cmd>wincmd l<CR>]], opts)
  vim.keymap.set('t', '<C-a><C-w>', [[<C-\><C-n><C-w>]], opts)
end
